...
There was an interesting paper about horse weight previously [@milner1969weight]. 
...
knitr::kable(max_horses, caption = "Table 1. Horse populations of each province in Canada between 1940 - 1972")
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap = paste("Figure 2. Historical number of horses in ",params$province), out.width = '100%'}
